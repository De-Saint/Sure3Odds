...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__setting_selection_add__ = __webpack_require__(792);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__interfaces_Selections__ = __webpack_require__(759);
...
var SettingSelectionAddPage = /** @class */ (function () {
    ...
    SettingSelectionAddPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["Component"])({
            selector: 'page-setting-selection-add',template:/*ion-inline-start:"/Users/mac/Downloads/Sure3Odds/src/pages/setting-selection-add/setting-selection-add.html"*/'\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Add Selection</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <div class="otherForm">\n    <ion-list>\n\n     \n      <!-- appear when click update -->\n      <ion-item >\n        <ion-label stacked>Name</ion-label>\n        <ion-input  type="text" [(ngModel)]="selection.name"  ></ion-input>\n        <ion-input hidden type="text" [(ngModel)]="selection.id"  ></ion-input>\n      </ion-item>\n      <!-- ==================================== -->\n    </ion-list>\n    <button ion-button block color="color2" (click)="onSubmit(selection)">Submit</button>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/mac/Downloads/Sure3Odds/src/pages/setting-selection-add/setting-selection-add.html"*/,
        }),
