...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__predictions__ = __webpack_require__(781);
    ...
    PredictionsPage.prototype.GetPredictions = function (currentdate) {
        ...
        this.gamesProvider.GetPredictions(currentdate)
            ...
            if (resp.statusCode === 200) {
                ...
                console.log(_this.predictionlist);
            }
            else {
