...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__all_matches__ = __webpack_require__(788);
    ...
    AllMatchesPage.prototype.onUpdateNow = function () {
        ...
        this.platform.ready().then(function () {
            if (_this.platform.is("ios")) {
                ...
                _this.openInAppStore("https://play.google.com/store/apps/details?id=com.whatsapp").then(function (response) {
